...
public class Itemnickelapple extends ItemFood implements IHasModel{
	...
	public Itemnickelapple(int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		setUnlocalizedName("xijun.nickelapple");
		setRegistryName("nickelapple");
