...
public class Itemxijunapple extends ItemFood implements IHasModel{
	...
	public Itemxijunapple(int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		setUnlocalizedName("xijun.xijunapple");
		setRegistryName("xijunapple");
