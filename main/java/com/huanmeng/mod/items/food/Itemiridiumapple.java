...
public class Itemiridiumapple extends ItemFood implements IHasModel{
	...
	public Itemiridiumapple(int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		setUnlocalizedName("xijun.iridiumapple");
		setRegistryName("iridiumapple");
