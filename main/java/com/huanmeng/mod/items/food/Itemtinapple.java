...
public class Itemtinapple extends ItemFood implements IHasModel{
	...
	public Itemtinapple(int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		setUnlocalizedName("xijun.tinapple");
		setRegistryName("tinapple");
