...
public class Itembronzeapple extends ItemFood implements IHasModel{
	...
	public Itembronzeapple(int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		setUnlocalizedName("xijun.bronzeapple");
		setRegistryName("bronzeapple");
