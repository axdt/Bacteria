...
public class Itemdiamondapple extends ItemFood implements IHasModel{
	...
	public Itemdiamondapple(int amount, boolean isWolfFood) {
		...
		setUnlocalizedName("xijun.diamondapple");
		setRegistryName("diamondapple");
    ...
    public EnumRarity EnumRarity(ItemStack stack)
    {
