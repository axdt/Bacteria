...
public class Itemironapple extends ItemFood implements IHasModel{
	...
	public Itemironapple(int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		setUnlocalizedName("xijun.ironapple");
		setRegistryName("ironapple");
