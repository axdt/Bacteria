...
public class Itemsteelapple extends ItemFood implements IHasModel{
	...
	public Itemsteelapple(int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		setUnlocalizedName("xijun.steelapple");
		setRegistryName("steelapple");
