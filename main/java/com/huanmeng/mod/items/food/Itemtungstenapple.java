...
public class Itemtungstenapple extends ItemFood implements IHasModel{
	...
	public Itemtungstenapple(int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		setUnlocalizedName("xijun.tungstenapple");
		setRegistryName("tungstenapple");
