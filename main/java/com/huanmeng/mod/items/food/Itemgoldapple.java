...
public class Itemgoldapple extends ItemFood implements IHasModel{
	...
	public Itemgoldapple(int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		setUnlocalizedName("xijun.goldapple");
		setRegistryName("goldapple");
