...
public class Itemplatinumapple extends ItemFood implements IHasModel{
	...
	public Itemplatinumapple(int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		setUnlocalizedName("xijun.platinumapple");
		setRegistryName("platinumapple");
