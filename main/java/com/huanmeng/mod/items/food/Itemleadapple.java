...
public class Itemleadapple extends ItemFood implements IHasModel{
	...
	public Itemleadapple(int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		setUnlocalizedName("xijun.leadapple");
		setRegistryName("leadapple");
