...
public class Itemsilverapple extends ItemFood implements IHasModel{
	...
	public Itemsilverapple(int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		setUnlocalizedName("xijun.silverapple");
		setRegistryName("silverapple");
