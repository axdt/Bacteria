...
public class Itemcopperapple extends ItemFood implements IHasModel{
	...
	public Itemcopperapple(int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		setUnlocalizedName("xijun.copperapple");
		setRegistryName("copperapple");
